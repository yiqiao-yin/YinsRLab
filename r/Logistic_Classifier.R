#' @title Supervised Classification ML Algorithm using Logistic Classifier
#' @description This function accepts input of data and parameteres and produce output of classification results.
#' @param symbol
#' @return NULL
#' @examples  Logistic_Classifier()
#' @export Logistic_Classifier
#'
#' # Define function
Logistic_Classifier <- function(
  x = all[, -1],
  y = all[, 1],
  cutoff = 0.9,
  fam = binomial,
